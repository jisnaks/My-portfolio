...
function Experience() {
    return (
        <div id="experience" className='container-fluid my-5 px-4 px-lg-5'>
            <h1 className='mx-auto'>Experience</h1>
            <div className='row g-4'>
                {
                    data?.experience?.map((item) => (
                        <motion.div variants={fadeInTopVariant} initial="hidden" whileInView="visible"
                            key={item.id} className="col-12 col-md-4 col-lg-4 d-flex justify-content-center py-5">
